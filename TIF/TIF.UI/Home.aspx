            ...
            <div class="jumbotron bg-primary text-white p-5 rounded mb-4">
                <div class="container-fluid py-5">
                    ...
                    <p class="col-md-8 fs-4">
                        Hola <strong><asp:Literal ID="NombreUsuario" runat="server"></asp:Literal></strong>, 
                        has iniciado sesión exitosamente en la tienda de insumos informaticos.
                    </p>
                    <p class="fs-6 text-light">
                        Última conexión: <asp:Literal ID="FechaHoraIngreso" runat="server"></asp:Literal>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="alert alert-info" role="alert">
                <h6 class="alert-heading">
                    <i class="bi bi-lightbulb"></i> Tip del Sistema
                </h6>
                <p class="mb-0">
